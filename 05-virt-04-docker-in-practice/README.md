...
# Домашнее задание к занятию 5. «Практическое применение Docker» - Морозов Александр
...
```
git clone https://github.com/Mars12121/shvirtd-example-python.git /opt/shvirtd-example-python
